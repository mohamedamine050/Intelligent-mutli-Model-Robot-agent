...
class Metaclass_WheelCommand(type):
    """Metaclass of message 'WheelCommand'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robot_msgs.msg.WheelCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__wheel_command
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__wheel_command
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__wheel_command
            cls._TYPE_SUPPORT = module.type_support_msg__msg__wheel_command
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__wheel_command
...
class WheelCommand(metaclass=Metaclass_WheelCommand):
    """Message class 'WheelCommand'."""
    ...
    def left_velocity(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'left_velocity' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def right_velocity(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'right_velocity' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
