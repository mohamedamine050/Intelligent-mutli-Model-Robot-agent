...
#include "robot_msgs/msg/detail/encoder__rosidl_typesupport_fastrtps_c.h"
...
using _Encoder__ros_msg_type = robot_msgs__msg__Encoder;
...
size_t get_serialized_size_robot_msgs__msg__Encoder(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Encoder__ros_msg_type * ros_message = static_cast<const _Encoder__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Encoder__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_msgs__msg__Encoder(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_msgs
size_t max_serialized_size_robot_msgs__msg__Encoder(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_msgs__msg__Encoder;
    is_plain =
      (
      offsetof(DataType, right_ticks) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Encoder__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_msgs__msg__Encoder(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_msgs, msg, Encoder)() {
