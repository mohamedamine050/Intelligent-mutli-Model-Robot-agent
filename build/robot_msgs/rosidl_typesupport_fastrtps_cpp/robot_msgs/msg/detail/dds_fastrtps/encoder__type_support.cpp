...
#include "robot_msgs/msg/detail/encoder__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_msgs::msg::Encoder & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_msgs::msg::Encoder & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_msgs::msg::Encoder;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_msgs::msg::Encoder *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_msgs::msg::Encoder *>(
    untyped_ros_message);
...
{
  return &robot_msgs::msg::typesupport_fastrtps_cpp::_Encoder__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msgs, msg, Encoder)() {
  return &robot_msgs::msg::typesupport_fastrtps_cpp::_Encoder__handle;
}
